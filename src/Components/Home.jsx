         ...
         <div>
            ...
            <div className='flex flex-wrap md:flex-nowrap py-8'>
               <div className='m-2 flex flex-col justify-center items-center py-1.5 px-4 rounded-3xl border border-[rgba(255,255,255,.3)] bg-[rgba(255,255,255,.05)] backdrop-blur-sm'>
                  ...
                  <h3 className='font-header font-semibold text-center text-xl my-1'>Set up your wallet</h3>
               ...
               <div className='m-2 flex flex-col justify-center items-center py-1.5 px-4 rounded-3xl border border-[rgba(255,255,255,.3)] bg-[rgba(255,255,255,.05)] backdrop-blur-sm'>
                  ...
                  <h3 className='font-header font-semibold text-center text-xl my-1'>Create your collection</h3>
               ...
               <div className='m-2 flex flex-col justify-center items-center py-1.5 px-4 rounded-3xl border border-[rgba(255,255,255,.3)] bg-[rgba(255,255,255,.05)] backdrop-blur-sm'>
                  ...
                  <h3 className='font-header font-semibold text-center text-xl my-1'>Add your NFTs</h3>
               ...
               <div className='m-2 flex flex-col justify-center items-center py-1.5 px-4 rounded-3xl border border-[rgba(255,255,255,.3)] bg-[rgba(255,255,255,.05)] backdrop-blur-sm'>
                  ...
                  <h3 className='font-header font-semibold text-center text-xl my-1'>List them for sale</h3>
